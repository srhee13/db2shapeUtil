...
public class ShapeHandler {
    ...
    public void write(String filepath, String filename,String shpType,String shpField, List<Map<String,Object>> schema,List<Map<String,Object>> values) {
        try {
            ...
            while (iterable.hasNext()){
                ...
                tb.length((int)map.get("COLUMN_SIZE"))
            ...
            if(shpType.equalsIgnoreCase("POINT")){
                ...
                tb.add("the_geom", Polyline.class);
            }else {
                tb.add("the_geom", Polygon.class);
            }
